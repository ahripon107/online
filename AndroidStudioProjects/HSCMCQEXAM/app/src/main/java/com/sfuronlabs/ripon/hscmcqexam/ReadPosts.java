 ...
 */
public class ReadPosts extends ListActivity{
    // Progress Dialog
    ...
    //private static final String READ_COMMENTS_URL = "http://vpn.gd/webservice/comments.php";
    private String READ_COMMENTS_URL = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String subject = intent.getExtras().getString("selUrl");
        url1 = intent.getExtras().getString("url1");
        url2 = intent.getExtras().getString("url2");
        ADDCOMMENTSURL = intent.getExtras().getString("url3");
        READ_COMMENTS_URL=subject;
    }
    ...
    public void addComment(View v) {
        Intent i = new Intent(ReadPosts.this, AddPosts.class);
        i.putExtra("url3",ADDCOMMENTSURL);
        startActivity(i);
    }
    ...
    private void updateList() {
        ...
        lv.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(ReadPosts.this,AddComment.class);
                ...
                i.putExtra("posttitle",mCommentList.get(position).get(TAG_TITLE));
                i.putExtra("postcontent",mCommentList.get(position).get(TAG_MESSAGE));
                startActivity(i);
    ...
    public class LoadComments extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ReadPosts.this);
